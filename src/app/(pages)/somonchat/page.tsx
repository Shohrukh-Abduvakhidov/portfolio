...
import screen1 from '@/app/assets/somon-chat-screen-1.png'

// Дополнительные данные о проекте
const projectData = {
	title: 'Somon Chat',
	description:
		'Somon Chat — это платформа для обмена сообщениями в реальном времени, разработанная для улучшения коммуникации между учителями, студентами и государственными служащими. Приложение обеспечивает безопасный и удобный способ общения, обмена файлами и организации групповых дискуссий.',
							...
							<TabsContent value='overview' className='space-y-4'>
								<div className='gradient-border rounded-lg p-6 bg-card/50 backdrop-blur-sm'>
									...
									<p className='text-muted-foreground mb-4'>
										Somon Chat был разработан для решения проблемы коммуникации
										между различными группами пользователей в образовательной и
										государственной сферах. Проект направлен на создание единой
										платформы для обмена сообщениями, которая была бы
										одновременно удобной, безопасной и функциональной.
									</p>
									<p className='text-muted-foreground'>
										Приложение поддерживает как личные, так и групповые чаты,
										обмен файлами различных форматов, а также имеет встроенную
										систему уведомлений и поиска. Интерфейс адаптирован для
										использования как на настольных компьютерах, так и на
